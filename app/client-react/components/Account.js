  ...
  return (
    <Fragment>
      ...
      <div className="grid-6 has-gutter">
        ...
        <div className="col-5">{personne.oid} <em>(vous pouvez le transmettre à un collègue pour qu’il vous ajoute à un groupe ou bien comme co-auteur d’une de ses ressource)</em></div>
