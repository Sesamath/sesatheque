  ...
  return (
    <Fragment>
      ...
      <div className="grid-6 has-gutter">
        ...
        <div className="col-5">{personne.pid} <em>(vous pouvez le transmettre à un collègue pour qu’il vous ajoute administrateur d’un groupe ou bien co-auteur d’une de ses ressources)</em></div>
