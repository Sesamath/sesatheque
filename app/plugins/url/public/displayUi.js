 ...
 */
const displayUi = async (ressource, options, next) => {
  ...
  $(async function () {
    ...
    try {
      ...
      if (hasCkeditor) editor = (await import('../../../client/editors/multiEditor')).default
      else if (hasMqEditor) editor = (await import('../../../client/editors/multiEditor')).default
