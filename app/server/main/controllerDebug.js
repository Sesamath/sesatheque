...
module.exports = function (component) {
  ...
  component.controller('debug', function () {
     ...
     * @private
     * @return {{contentBloc: {$view: string}}}
     */
    ...
    controller.get('error', function (context) {
      const error = context.get.error || 'demande d’affichage d’erreur sans erreur fournie'
      context.layout = 'page'
    ...
    controller.get('extUp', function (context) {
      ...
      const options = {
        ...
        body: {
          ref: {
            type: 'j3p',
            aliasOf: 'communlocal3003/3017',
            titre: 'Calculs',
            description: 'Exemple de consigne'
          }
        },
        timeout: 3000
      }
