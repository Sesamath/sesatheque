            ...
            items: function (node, cb) {
              ...
              if (isArbreRef) {
                items.editRef = {
                  label: "Éditer",
                  action: function () {
                    if (isDstModified) page.addError("Enfants de l'arbre modifiés mais non sauvegardé " +
                        "(recharger la page pour annuler les modifications avant d'éditer un arbre enfant)")
