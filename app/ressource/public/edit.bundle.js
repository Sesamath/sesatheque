...
;require.register("edit/formEditor", function(exports, require, module) {
/**
 * This file is part of Sesatheque.
 *   Copyright 2014-2015, Association Sésamath
 *
...
function addWrapper(parent, options) {
  ...
  if (divAttrs.class) divAttrs.class = "control-group";else divAttrs.class += " control-group";
...
function addFormGroup(element, position) {
  ...
  if (!element) {
    ...
    if (element.length) element = element[0];else throw new Error("Aucun form dans la page");
  }
  var addMethod = dom.addElement;
  if (element && position) {
    if (position === "after") addMethod = dom.addElementAfter;else if (position === "before") addMethod = dom.addElementBefore;else if (position === "firstSibling") addMethod = dom.addElementFirstSibling;else if (position === "firstChild") addMethod = dom.addElementFirstChild;
  }
...
function addCheckboxes(parent, name, options, checkboxes) {
  ...
  if (checkboxes instanceof Array) {
    checkboxes.forEach(function (checkbox, i) {
      ...
      if (checkboxes.length > 1) attrs.name = name + "[" + i + "]";else attrs.name = name;
...
function addSelect(parent, attrs, options, choix) {
  ...
  if (choix instanceof Array) {
    choix.forEach(function (optionAttrs) {
      ...
      if (optionAttrs.selected) optionAttrs.selected = "selected";else delete optionAttrs.selected;
...
;require.register("edit/init", function(exports, require, module) {
/**
 * This file is part of Sesatheque.
 *   Copyright 2014-2015, Association Sésamath
 *
...
;require.register("plugins/arbre/edit", function(exports, require, module) {
/**
 * This file is part of Sesatheque.
 *   Copyright 2014-2015, Association Sésamath
 *
  ...
  try {
    page.loadAsync(['apiClient'], function () {
      ...
      function loadDst(arbre) {
        ...
        var jstData = {
          core: {
            check_callback: function check_callback(action, node, parent) {
            ...
            items: function items(node, cb) {
              ...
              if (!isRacine) {
                items.remove = {
                  ...
                  action: function action(data) {
                    ...
                    if (inst.is_selected(node)) inst.delete_node(inst.get_selected());else inst.delete_node(node);
                    isDstModified = true;
                  },
              ...
              if (isArbreRef) {
                items.editRef = {
                  label: "Éditer",
                  action: function action() {
                    if (isDstModified) page.addError("Enfants de l'arbre modifiés mais non sauvegardé " + "(recharger la page pour annuler les modifications avant d'éditer un arbre enfant)");else window.location = "/ressource/modifier/" + node.a_attr["data-ref"];
                  }
                };
              }
        ...
        $dstTree.on('select_node.jstree', function (e, data) {
          ...
          if (jstNode && jstNode.a_attr && jstNode.a_attr['data-type'] === 'arbre') {
            // on fait du toggle
            if ($dstTree.jstree('is_open', data.node)) $dstTree.jstree('close_node', data.node);else $dstTree.jstree('open_node', data.node);
          }
        });
      } // loadDst
          ...
          apiClient.getRessource(ref, function (error, ressource) {
            if (error) {
              ...
              $srcTree.on('select_node.jstree', function (e, data) {
                ...
                if (jstNode && jstNode.a_attr && jstNode.a_attr['data-type'] === 'arbre') {
                  // on fait du toggle
                  if ($srcTree.jstree('is_open', data.node)) $srcTree.jstree('close_node', data.node);else $srcTree.jstree('open_node', data.node);
                }
              });
...
;require.register("plugins/ec2/edit", function(exports, require, module) {
/**
 * This file is part of Sesatheque.
 *   Copyright 2014-2015, Association Sésamath
 *
...
;require.register("plugins/ecjs/edit", function(exports, require, module) {
/**
 * This file is part of Sesatheque.
 *   Copyright 2014-2015, Association Sésamath
 *
...
var typesEc = ["addiclic", "approximationsomme", "balance", "balanceadd", "basketmath", "basketmath2p", "basketmath3p", "bocal", "bouleetboule", "bouleetbouledecimaux", "calculdiffere", "carre", "chocolat1", "chocolat2", "cibles", "complement", "croupier", "decollage", "diviclic", "elephants", "estimation", "frise", "grenouille", "lacaisse", "lebanquier", "lesbornes", "mbrique", "memory", "mistral", "multiclic", "nombresympathique", "numbercrushdecimaux", "oiseauaddition", "oiseaumultiplication", "operationsatrous", "planeteaddition", "quadricalc", "quadricalcinv", "recette", "rectangle", "sommeenligne", "supermarche", "surfacebleue", "tableattaque", "tapisdecarte", "train", "viaduc"];
...
;require.register("plugins/iep/edit", function(exports, require, module) {
/**
 * This file is part of Sesatheque.
 *   Copyright 2014-2015, Association Sésamath
 *
...
module.exports = function edit(ressource) {
  ...
  try {
    ...
    formEditor.addInputText(groupParametres, { name: "parametres[width]", size: 5, value: parametres.width || "", placeholder: "largeur" }, { label: "largeur", remarque: "(en pixels)" });
    formEditor.addInputText(groupParametres, { name: "parametres[height]", size: 5, value: parametres.height || "", placeholder: "hauteur", "class": "center" }, { label: "hauteur", remarque: "(en pixels)" });
    var $parametresUrl = $(formEditor.addInputText(groupParametres, { name: "parametres[url]", id: "parametresUrl", size: 80, value: parametres.url || "", placeholder: "Entrer une url absolue (http…)" }, { label: "url", remarque: "(ira lire le script de cette url à chaque affichage si le champ xml est vide)" }));
    ...
    var xmlElt = formEditor.addTextarea(xmlWrapper, { name: "parametres[xml]", cols: 80, rows: 20, style: { resize: "both" } }, { label: "Script instrumenpoche" });
    var $xmlElt = $(xmlElt);
    $("form#formRessource").submit(function () {
      var url = $parametresUrl.val();
      var xml = $xmlElt.val();
      var retour = false;
      if (url && /https?:\/\/[a-z][a-z0-9\-_\.]+\.[a-z]+\/.+/.test(url)) retour = true;else if (url) page.addError("Url invalide");else if (xml) retour = true;else page.addError("Il faut au moins une url ou un script");
...
;require.register("plugins/j3p/edit", function(exports, require, module) {
/**
 * This file is part of Sesatheque.
 *   Copyright 2014-2015, Association Sésamath
 *
  ...
  window.addEventListener("message", function (event) {
    ...
    if (event.data) {
      ...
      if (event.data.action === "editGrapheReady") {
        ...
        if (event.data.parametres) saveParametres(event.data.parametres);else page.addError("editgraphe envoi un message avec l'action saveParametres sans fournir parametres");
...
function resizeIframe() {
  ...
  if (tailleDispo < 300) $editgraphe.width(300);else $editgraphe.css("width", '100%');
...
egWindow,
    ...
    // on a envoyé le postMessage
isSubmitForced = false,
    // pour forcer le submit, postMessage fait ou pas
$textarea;
var wd = window.document;
...
;require.register("plugins/mathgraph/edit", function(exports, require, module) {
/**
 * This file is part of Sesatheque.
 *   Copyright 2014-2015, Association Sésamath
 *
...
var allowProf, levelEleve, levelProf, figureBase64Ini, width, height, $width, $height, appletContainer, $appletContainer, $figureData, $isFullSize, $dataContainer, $form;
...
module.exports = function mathgraphEdit(ressource) {
  try {
    ...
    var widthInput = formEditor.addInputText(sizeGroup, { name: "parametres[width]", size: 5, value: width, placeholder: "largeur" }, { label: "largeur", remarque: "(en pixels)" });
    $width = $(widthInput);
    var heightInput = formEditor.addInputText(sizeGroup, { name: "parametres[height]", size: 5, value: height, placeholder: "hauteur", "class": "center" }, { label: "hauteur", remarque: "(en pixels)" });
    $height = $(heightInput);
    formEditor.addCheckboxes(sizeGroup, "parametres[profFullSize]", { label: "exception formateur" }, [{
      id: "isFullSize",
    ...
    var levelEleveSelect = formEditor.addSelect(eleveGroup, { id: "selectTypeInterface", name: "parametres[levelEleve]" }, {
      label: "type d'interface élève",
      wrapperAttributes: { style: "max-width:300px;" }
    }, [{ value: "0", content: "lecteur seulement*", selected: levelEleve === 0 }, { value: "1", content: "éditeur élémentaire", selected: levelEleve === 1 }, { value: "2", content: "éditeur collège", selected: levelEleve === 2 }, { value: "3", content: "éditeur avancé sans nombres complexes", selected: levelEleve === 3 }, { value: "4", content: "éditeur avancé avec nombres complexes", selected: levelEleve === 4 }]);
    dom.addElementAfter(levelEleveSelect, 'div', { "class": "remarque" }, "* L'éditeur nécessite java, le lecteur simple est conseillé si vous n'avez pas besoin de récupérer la figure de l'élève");
    ...
    var allowEleveCb = formEditor.addCheckboxes(eleveGroup, "parametres[allowEleve]", { label: "fonctionnalités accessibles aux élèves", remarque: "(ne concerne que l'éditeur)" }, checkboxes);
    ...
    $levelEleveSelect.change(function () {
      ...
      if (levelEleve === 0) $allowEleveCb.hide();else $allowEleveCb.show();
    });
    ...
    var levelProfSelect = formEditor.addSelect(profGroup, { name: "parametres[levelProf]" }, { label: "type d'interface formateur", remarque: "(utilisée ci-dessous)" }, [{ value: "-1", content: "aucune (zone pour coller une figure exportée)", selected: levelProf === -1 }, { value: "0", content: "identique aux élèves", selected: levelProf === 0 }, { value: "1", content: "éditeur élémentaire", selected: levelProf === 1 }, { value: "2", content: "éditeur collège", selected: levelProf === 2 }, { value: "3", content: "éditeur avancé sans nombres complexes", selected: levelProf === 3 }, { value: "4", content: "éditeur avancé avec nombres complexes", selected: levelProf === 4 }]);
    ...
    var allowProfCb = formEditor.addCheckboxes(profGroup, "parametres[allowProf]", { label: "fonctionnalités formateur", remarque: "(ci-dessous)" }, checkboxes);
    ...
    var figureData = formEditor.addTextarea(dataContainer, { id: "figure", name: "parametres[figure]", cols: 80, rows: 5 }, { label: "Figure (encodée en base64)", content: figureBase64Ini });
    ...
    if (isApplet) showApplet();else $allowProfCb.hide(); // pas de hideApplet tant qu'on l'a pas mise
  } catch (error) {
    page.addError(error);
  }
};
...
;require.register("plugins/url/edit", function(exports, require, module) {
/**
 * This file is part of Sesatheque.
 *   Copyright 2014-2015, Association Sésamath
 *
...
module.exports = function edit(ressource, options) {
  ...
  function addOptions(blocParam, parametres) {
    ...
    addOption(divConsigneOptions, "question_option", "aucune", "off", function () {
      $divConsigne.hide();
    });
    addOption(divConsigneOptions, "question_option", "avant", "before", function () {
      $divConsigne.show();
    });
    addOption(divConsigneOptions, "question_option", "pendant", "while", function () {
      $divConsigne.show();
    });
    addOption(divConsigneOptions, "question_option", "après", "after", function () {
      $divConsigne.show();
    });
  ...
  function initDom(parametres, options) {
    ...
    dom.addElement(apercu, 'p', { style: { float: "right", margin: "3em 1em" } }, "Cet aperçu miniature permet de vérifier que " + "le site autorise l'affichage incrusté (dans une iframe).");
    var divTaille = dom.addElement(apercu, 'div');
    dom.addText(divTaille, "Vous pouvez forcer une dimension d'affichage (déconseillé pour une page, mieux vaut laisser " + "vide et laisser le navigateur s'adapter, mais cela peut être utile pour une image).");
    ...
    dom.addText(instructions, "Il est possible d'accompagner la page internet d'une consigne et même de demander " + "à l'élève de saisir un texte dans une zone de réponse.");
    dom.addElement(instructions, 'br');
...
;require.register("editors/jsonMulti/index", function(exports, require, module) {
/**
 * This file is part of Sesatheque.
 *   Copyright 2014-2015, Association Sésamath
 *
...
function addLinks(config) {
  ...
  function addLink(container, editorName) {
    var elt;
    var args = { onclick: function onclick() {
  ...
  for (var editorName in editors) {
    if (editors.hasOwnProperty(editorName)) {
      if (first) first = false;else dom.addText(divChoices, " - ");
  ...
  try {
    ...
    if (editorName !== current) {
      if (current === "simple") {
        ...
        if (isJsonValide(json)) setNew(json);else throw new Error("Le json est invalide");
      } else {
        setSimple(setNew);
      }
    } else {
...
try {
    ...
    jsoneditor: {
      ...
      set: function set(obj) {
        initJsonEditor(function (error) {
          if (error) page.addError(error.toString(), 5);else if (jsonEditor) jsonEditor.set(obj);else page.addError("jsonEditor n'a pas été correctement initialisé mais l'initialisation n'a pas renvoyé d'erreur");
        });
      }
    }
  };
  ...
  jsonMulti.init = function (textarea, config, options, next) {
    ...
    try {
      ...
      if (next) next(error);else throw error;
    }
  };
} catch (error) {
  page.addError(error);
...
;require.register("editors/mqEditor/index", function(exports, require, module) {
/**
 * This file is part of Sesatheque.
 *   Copyright 2014-2015, Association Sésamath
 *
  ...
  mqEditor.init = function (textarea, config, options, next) {
    try {
      $(function () {
        ...
        if (!config) config = defaultConfig;else if (config === "default") config = defaultConfig;else if (config === "full") config = fullConfig;
...
module.exports = mqEditor;
});

;require.register("editors/multiEditor/index", function(exports, require, module) {
/**
 * This file is part of Sesatheque.
 *   Copyright 2014-2015, Association Sésamath
 *
...
function addLinks(config) {
  ...
  if (config.optionsName) $toCkEditorLink = $(link);else dom.addText(divChoices, " - ");
  link = addLink("mathquill");
  if (config.optionsName) $toMathquillLink = $(link);else dom.addText(divChoices, " - ");
    ...
    try {
      ...
      multiEditor.toSimple(function (error) {
        if (error) {
          ...
          //  $textarea.val(contenu +" $$")
          //}
          if (contenuSsTxt.indexOf(" ") === -1 || window.confirm("Attention, l'éditeur d'équation supprime les espaces (hors commande \text{})," + " annuler pour revenir à l'éditeur simple")) {
            init();
          }
        }
      });
...
;
//# sourceMappingURL=edit.bundle.js.map/*! head.load - v1.0.3 */
