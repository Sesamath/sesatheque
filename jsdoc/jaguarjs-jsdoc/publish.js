...
function generateNavigation(members) {
    var nav = {};
    ...
    if (members.classes.length) {
      _.each(members.classes, function (v) {
        var type = v.exkind?v.exkind:'classes';
        nav[type].items.push({
          type: type,
          longname: v.longname,
          name: v.name,
...
exports.publish = function(taffyData, opts, tutorials) {
    ...
    // once for all
    view.nav = generateNavigation(members);
    ...
    function generateTutorial(title, tutorial, filename) {
        var tutorialData = {
            ...
            // thanks to Anon http://stackoverflow.com/a/26717198
            filename: filename
        };
