  ...
  return function (ressource, options, next) {
    ...
    window.jQuery(function ($) {
      ...
      function loadDependencies(next) {
        ...
        if (dependances.length) require(dependances, function () {
          // On laisse tomber ce code car on lance le rendering sur la consigne seulement à son ouverture
          //if (hasTexConsigne) {
          //  // @see https://github.com/mathjax/MathJax-docs/wiki/Integrating-mathjax-into-x%3A-require.js
          //  MathJax.Hub.Config({
          //    tex2jax: {
          //      inlineMath: [['\\(', '\\)']],
      ...
      function setEtapes() {
        ...
        if (question_option == "off") {
          ...
          if (answer_option == "off") {
            ...
            information.setContent("Lis la consigne, clique sur ", lienSuivant, " pour voir le document, puis encore une fois pour répondre.");
            etapes.liste.push([reponse]);
          ...
          if (answer_option == "after") {
            ...
            information.setContent("Lis la consigne, observe bien le document puis clique sur ", lienSuivant, " pour pouvoir répondre.");
            etapes.liste.push([reponse]);
          ...
          if (answer_option == "off") {
            ...
            information.setContent("Observe bien le document puis clique sur ", lienSuivant, " pour lire la consigne et encore une fois pour répondre.");
            etapes.liste.push([reponse]);
          }
          else {
      ...
      var hasTexConsigne = ($("#consigne .math-tex").length > 0);
