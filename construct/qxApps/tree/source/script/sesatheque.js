...
var envinfo = {"qx.application":"sesatheque.Application","qx.revision":"","qx.theme":"sesatheque.theme.Theme","qx.version":"4.0.1"};
for (var k in envinfo) qx.$$environment[k] = envinfo[k];

if (!qx.$$libraries) qx.$$libraries = {};
var libinfo = {"__out__":{"sourceUri":"script"},"qx":{"resourceUri":"../../qooxdoo/framework/source/resource","sourceUri":"../../qooxdoo/framework/source/class","sourceViewUri":"https://github.com/qooxdoo/qooxdoo/blob/%{qxGitBranch}/framework/source/class/%{classFilePath}#L%{lineNumber}"},"sesatheque":{"resourceUri":"../source/resource","sourceUri":"../source/class"}};
